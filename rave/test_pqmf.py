...
def main() -> None:
    print(f'{"n":>3} {"taps":>4} {"SNR_r":>7} {"SNR_c":>7} ' f'{"gain":>6} {"delay":>6}')
    print('-' * 42)
    for n_bands, taps in [(8, 62), (8, 126), (16, 126), (16, 254)]:
        ...
        print(f'{n_bands:>3} {taps:>4} {snr_n:>7.2f} {snr_c:>7.2f} ' f'{gain:>6.3f} {delay:>6}')
    ...
    print()
    print(f'SNR de PQMF(16, 254) reportado por el módulo: ' f'{pqmf.reconstruction_snr_db:.2f} dB, gain={pqmf.roundtrip_gain:.4f}')
